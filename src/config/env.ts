...
const envSchema = z.object({
  ...
  NEXTAUTH_SECRET: z
    ...
    .min(32, { message: "NEXTAUTH_SECRET must be at least 32 character long" }).default(process.env.NEXTAUTH_SECRET as string),
  GOOGLE_CLIENT_ID: z
    .string({ message: "Google Client ID is Required" })
    .default(process.env['GOOGLE_CLIENT_ID'] as string),
  GOOGLE_CLIENT_SECRET: z
    .string({ message: "Google Client Secret is Required" })
