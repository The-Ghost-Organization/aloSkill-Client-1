...
// Mock data
const stats = [
  { label: 'Total Courses', value: '357', icon: BookOpen, color: 'bg-orange-100', iconColor: 'text-orange-500' },
  { label: 'Total Students', value: '19', icon: Users, color: 'bg-purple-100', iconColor: 'text-purple-500' },
  { label: 'Total Instructors', value: '241', icon: Users, color: 'bg-orange-100', iconColor: 'text-orange-500' },
  { label: 'Total Enrolled', value: '953', icon: BookOpen, color: 'bg-green-100', iconColor: 'text-green-500' },
  { label: 'Total Courses', value: '357', icon: BookOpen, color: 'bg-orange-100', iconColor: 'text-orange-500' },
  { label: 'Total Students', value: '19', icon: Users, color: 'bg-purple-100', iconColor: 'text-purple-500' },
  { label: 'Total Instructors', value: '241', icon: Users, color: 'bg-orange-100', iconColor: 'text-orange-500' },
  { label: 'Total Enrolled', value: '955', icon: BookOpen, color: 'bg-green-100', iconColor: 'text-green-500' },
];

const activities = [
  { action: 'Nolan published new article', detail: '"What is UX" in user\'s design what will happen', time: '2 hours ago', color: 'bg-orange-500' },
  { action: 'Arlene is out of office at your course', detail: 'SEO take your blog', time: '3 hours ago', color: 'bg-orange-500' },
  { action: 'Subbed', detail: 'purchase your course "SEO" and design what will happen', time: '4 hours ago', color: 'bg-orange-500' },
  { action: 'Von is trusting you course', detail: 'SEO has been design with your blog', time: '1 hours ago', color: 'bg-orange-500' },
];
    ...
    <div className="">
      <div className="flex flex-col gap-4 overflow-auto">
        ...
        <div className="w-full grid grid-cols-4 gap-4">
          {stats.map((stat, idx) => (
            <div key={idx} className="bg-white rounded px-3 py-2 flex items-center gap-3">
            ...
            <div className="flex items-center gap-5">
              <div className="flex items-center gap-5">
                ...
                <div className="w-64 h-3 bg-[#172b5d] overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-green-400 to-green-500" style={{ width: '30%' }}></div>
                </div>
              </div>
