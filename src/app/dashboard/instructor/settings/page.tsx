            ...
            <div className="bg-white w-full rounded p-4">
                ...
                <div className=" flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-orange-500 pr-2 border-r border-gray-200">🌐</span>
                            <input
                                type="url"
                    ...
                    <div className="flex items-center gap-4">
                        <div className='w-full'>
                            ...
                            <div className="relative">
                                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-orange-500 pr-2 border-r border-gray-200">f</span>
                                <input
                                    type="text"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div className="relative">
                                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-orange-500 pr-2 border-r border-gray-200">in</span>
                                <input
                                    type="text"
                                    placeholder="Username"
                                    className="w-full pl-14 pr-3 py-1.5 border border-gray-200 rounded focus:outline-none focus:ring-1 focus:ring-orange-light focus:border-transparent placeholder:text-sm"
