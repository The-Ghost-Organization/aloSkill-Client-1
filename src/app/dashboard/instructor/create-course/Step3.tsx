...
export default function Step3({ currentStep, setCurrentStep }: { currentStep: number, setCurrentStep: (step: number) => void }) {
    ...
    return (
        <div className="w-full bg-white">
            {/* Header */}
            <StepHeader headingText='Course Curriculum' handleSave={handleSave} handleSaveAndPreview={handleSaveAndPreview} />
            {/* Form Content */}
            <div className="p-6">
                {/* Sections */}
                <div className="space-y-4">
                    {sections.map((section, sectionIndex) => (
                        <div key={section.id} className="bg-gray-50 rounded p-4">
                            {/* Section Header */}
                            <div className="flex items-center justify-between pb-4">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        onClick={()=>setSectionNameEditModal(true)}
                                        className="p-1.5 hover:bg-gray-200 rounded transition-colors">
                                    ...
                                    <div key={lecture.id} className='relative'>
                                        ...
                                        {lecture.expanded && (
                                            <div className="bg-white rounded w-[20%] z-100 absolute right-[10%] p-2">
                                                <button
                                                    onClick={() => setLectureVideoUploadModal(true)}
...

            {
                sectionNameEditModal &&
                    <SectionNameEditModal setSectionNameEditModal={setSectionNameEditModal} />
            }
            {
