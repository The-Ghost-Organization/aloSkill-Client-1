        ...
        <div className="min-h-screen">
            ...
            <div className="space-y-4">
                {purchaseData.map((purchase, index) => (
                    <div key={index} className="bg-white rounded shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
                        {/* Header Section */}
                        <div
                            className={`p-4 cursor-pointer transition-colors duration-200 ${expandedDates[index] ? 'bg-gradient-to-r from-pink-50 to-purple-50' : 'hover:bg-gray-50'
                                }`}
                            ...
                            <div className="border-t border-gray-100">
                                ...
                                <div className="p-5 space-y-4">
                                    {purchase.items.map((item) => (
                                        <div key={item.id} className="flex gap-4 p-4 rounded bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                                            <Image
                                                width={80}
                                                height={80}
                                                src={item.image}
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex items-center gap-2">
                                                            <div className="flex items-center gap-1">
                                                                ...
                                                                <span className="text-xs text-gray-500">({item.reviews.toLocaleString()} Reviews)</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        <div className="flex items-center gap-8">
                                            ...
                                            <div>
                                                ...
                                                <span className="font-semibold text-gray-800">${purchase.amount.toFixed(2)} USD</span>
                                            </div>
                                            <div className="flex items-center gap-1">
                                                <CreditCard className="w-4 h-4 text-green-600" />
                                        ...
                                        <div className="text-right">
                                            ...
                                            <div className="text-gray-800 font-mono">•••• •••• •••• {purchase.cardLast4}</div>
