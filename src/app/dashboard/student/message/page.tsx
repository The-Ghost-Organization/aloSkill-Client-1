...
const MessagePage = () => {
    ...
    const contacts = [
        { id: 1, name: 'Jane Cooper', message: 'Yeah sure, let me zabbr', time: 'just now', avatar: '👩', active: true, unread: 0 },
        { id: 2, name: 'Jenny Wilson', message: 'Thank you so much, uli', time: '2 d', avatar: '👩‍🦰', active: false, unread: 2 },
        { id: 3, name: 'Marvin McKinney', message: 'You\'re Welcome', time: '1 h', avatar: '👨', active: false, unread: 0 },
        { id: 4, name: 'Eleanor Pena', message: 'Thank you so much, uli', time: '1 m', avatar: '👩‍🦱', active: false, unread: 1 },
        { id: 5, name: 'Ronald Richards', message: 'Sorry, i can\'t help you', time: '2 m', avatar: '👨‍🦲', active: false, unread: 0 },
        { id: 6, name: 'Kathryn Murphy', message: '', time: '2 m', avatar: '👩‍🦳', active: false, unread: 0 },
        { id: 7, name: 'Jacob Jones', message: 'Thank you so much, uli', time: '6 m', avatar: '👨‍🦱', active: false, unread: 0 },
        { id: 8, name: 'Cameron Williamson', message: 'Its okay, no problem bruno, i will fix everythin...', time: '8 m', avatar: '👨‍🦰', active: false, unread: 0 },
        { id: 9, name: 'Arlene McCoy', message: 'Thank you so much, uli', time: '9 m', avatar: '👩‍🦲', active: false, unread: 0 },
        { id: 10, name: 'Dianne Russell', message: 'You\'re Welcome', time: '9 m', avatar: '👩', active: false, unread: 0 }
    ];
                ...
                <div className="flex-1 overflow-y-auto">
                    {contacts.map((contact) => (
                        <div
                            ...
                            className={`flex items-center gap-3 p-4 hover:bg-gray-50 cursor-pointer border-b border-gray-100 ${selectedContact === contact.id ? 'bg-blue-50' : ''
                                }`}
                        >
                            <div className="relative">
                ...
                <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-green-600">{currentContact?.active ? 'Active Now' : 'Offline'}</p>
                        </div>
                    </div>
                    ...
                    {currentMessages.map((message) => (
                        <div key={message.id} className="flex flex-col">
                            ...
                            <div className={`flex items-start gap-3 ${message.isOwn ? 'flex-row-reverse' : ''}`}>
                                ...
                                <div className={`flex flex-col ${message.isOwn ? 'items-end' : 'items-start'} max-w-lg`}>
                                    {!message.isOwn && (
                ...
                <div className="px-6 py-4 border-t border-gray-200">
                    <div className="flex items-center gap-3">
                        <input
                            ...
                            className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                        />
                        <button
                            onClick={handleSend}
